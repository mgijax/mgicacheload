...
#
# Usage:  vocmarker.csh
# Purpose: refreshes VOC_Marker_Cache with marker/term associations; does a
...
${MGD_DBSCHEMADIR}/index/VOC_Marker_Cache_drop.object | tee -a ${LOG}
...
${MGD_DBSCHEMADIR}/index/VOC_Marker_Cache_create.object | tee -a ${LOG}
